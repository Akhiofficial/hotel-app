...
<body>
    ...
    <section class="hero-section">
        ...
        <div class="hero-content">
            ...
            <p>Experience luxury and comfort in the heart of the city. Book your room today and enjoy world-class hospitality.</p>
        ...
        <div class="container">
            ...
            <div class="properties-grid">
                ...
                <div class="property-card" data-room-type="<?=esc($room['title'])?>">
                    <div class="property-image" style="background-image: url('<?=esc($imagePath)?>'); background-size: cover; background-position: center;">
                    ...
                    <div class="property-info">
                        ...
                        <p class="property-details">
                            <i class="fas fa-users"></i> Capacity: <?=esc($room['capacity'])?> Guest<?=esc($room['capacity']) > 1 ? 's' : ''?>
                            <?php if(!empty($room['quantity'])): ?>
                                <span style="margin-left: 15px;">
                                    <i class="fas fa-bed"></i> Available: <?=esc($room['quantity'])?> Room<?=esc($room['quantity']) > 1 ? 's' : ''?>
                                </span>
                            <?php endif; ?>
                        </p>
                        <p class="property-description"><?=esc($room['description'] ?? 'Comfortable and well-appointed room with modern amenities.')?></p>
    ...
    <section class="all-hotels" id="all-rooms">
        <div class="container">
            ...
            <div class="filter-buttons">
                ...
                <?php foreach($roomTypes as $type): ?>
                    <button class="filter-btn" data-filter="<?=esc($type)?>"><?=esc($type)?></button>
                <?php endforeach; ?>
            </div>
            <div class="properties-grid" id="roomsGrid">
                ...
                <div class="property-card" 
                     data-room-type="<?=esc($room['title'])?>" 
                     data-room-id="<?=esc($room['id'])?>">
                    <div class="property-image" style="background-image: url('<?=esc($imagePath)?>'); background-size: cover; background-position: center;"></div>
                    <div class="property-info">
                        <div class="property-price">₹<?=number_format($room['price'], 2)?> /night</div>
                        <h3><?=esc($room['title'])?></h3>
                        <p class="property-code">Room Code: <?=esc($room['code'])?></p>
        ...
        <div class="container">
            ...
            <div class="services-carousel">
                <div class="service-card">
                    <div class="service-image" style="background-image: url('https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=600')"></div>
                ...
                <div class="service-card">
                    <div class="service-image" style="background-image: url('https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=600')"></div>
                    <div class="service-overlay">
                        <h3>Swimming Pool</h3>
                ...
                <div class="service-card">
                    <div class="service-image" style="background-image: url('https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=600')"></div>
                    <div class="service-overlay">
                        <h3>Restaurant</h3>
                ...
                <div class="service-card">
                    <div class="service-image" style="background-image: url('https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=600')"></div>
                    <div class="service-overlay">
                ...
                <div class="service-card">
                    <div class="service-image" style="background-image: url('https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600')"></div>
                    <div class="service-overlay">
                        <h3>Parking</h3>
        ...
        <div class="container">
            ...
            <div class="testimonial-carousel">
                ...
                <div class="testimonial-card">
                    ...
                    <p class="testimonial-text">Staying at BOOKINN Hotel was an absolute delight! The rooms were spotless, the staff was incredibly friendly, and the service was exceptional. The seamless check-in process and the delicious breakfast made my trip even more memorable. I can't wait to come back!</p>
                    <h4>Emily Watson</h4>
                    <div class="property-rating">
                        <?php for($i=0; $i<5; $i++): ?>
                            <i class="fas fa-star"></i>
        ...
        <div class="container">
            <div class="footer-grid">
                <div class="footer-col">
                    ...
                    <p>Experience luxury and comfort in the heart of the city. We're committed to providing exceptional hospitality and unforgettable stays for all our guests.</p>
