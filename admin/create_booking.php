                    ...
                    <form method="post" id="bookingForm">
                        <div class="form-grid">
                                ...
                                <select name="room_id" id="room_id" required onchange="calculateTotal()">
                                    ...
                                    <?php foreach($rooms as $room): ?>
                                        <option value="<?=esc($room['id'])?>" data-price="<?=esc($room['price'])?>">
                                            <?=esc($room['code'])?> - <?=esc($room['title'])?> (₹<?=number_format($room['price'], 2)?>/night)
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="checkin" id="checkin" required onchange="checkAvailability(); calculateTotal();" min="<?=date('Y-m-d')?>">
                            </div>
                            
                            <div class="form-group">
                                <label>Check-out Date *</label>
                                <input type="date" name="checkout" id="checkout" required onchange="checkAvailability(); calculateTotal();" min="<?=date('Y-m-d')?>">
                            </div>
