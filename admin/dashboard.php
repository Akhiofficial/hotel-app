...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/fullcalendar@6.1.8/main.min.css" rel="stylesheet" onerror="this.onerror=null; this.href='https://unpkg.com/fullcalendar@6.1.8/main.min.css';">
            ...
            <div class="dashboard-grid">
                ...
                <div class="dashboard-left">
                    ...
                    <div class="calendar-card">
                        <div class="chart-header">
                            ...
                            <div>
                                <select id="roomFilter" class="period-select" style="margin-right: 10px;">
                                    ...
                                    ?>
                                        <option value="<?=esc($room['id'])?>"><?=esc($room['code'])?> - <?=esc($room['title'])?></option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div id="calendarError" style="display:none; padding: 20px; text-align: center; color: #666; background: #f8f9fa; border-radius: 8px; margin-top: 10px;">
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <?php if($b['status'] === 'pending'): ?>
                                                <button class="btn-icon btn-success" onclick="quickVerify(<?=esc($b['id'])?>)" title="Mark Paid">
                                                    <i class="fas fa-check"></i>
                                                </button>
                                            <?php endif; ?>
                                            <a href="invoice.php?id=<?=esc($b['id'])?>" target="_blank" class="btn-icon btn-info" title="View Bill">
                                                <i class="fas fa-file-invoice"></i>
                                            </a>
                                            <a href="bookings.php#booking-<?=esc($b['id'])?>" class="btn-icon btn-primary" title="View Details">
